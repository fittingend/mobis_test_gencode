...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ZONE_USSFRONT_INPUT_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ZONE_USSFRONT_INPUT_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
class Zone_UssFront_InputProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Zone_UssFront_InputProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Zone_UssFront_InputProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Zone_UssFront_InputProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Zone_UssFront_InputProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Zone_UssFront_InputProxy::HandleType> handleContainer;
    ...
    ~Zone_UssFront_InputProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Zone_UssFront_InputProxy(Zone_UssFront_InputProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Zone_UssFront_InputProxy& operator=(const Zone_UssFront_InputProxy& other) = delete;
    /// @brief Move constructor
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Zone_UssFront_InputProxy& operator=(Zone_UssFront_InputProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ZONE_USSFRONT_INPUT_PROXY_H