...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ZONE_VEHICLEINFO_INPUT_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ZONE_VEHICLEINFO_INPUT_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "zone_vehicleinfo_input_common.h"
...
public:
    ...
    using SampleType = zone::input::type::VehicleInfo;
    /// @brief Constructor
    explicit VehicleInfo(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
    virtual ~VehicleInfo() = default;
    /// @brief Delete copy constructor
    VehicleInfo(const VehicleInfo& other) = delete;
    /// @brief Delete copy assignment
    VehicleInfo& operator=(const VehicleInfo& other) = delete;
    /// @brief Move constructor
    VehicleInfo(VehicleInfo&& other) noexcept : mInterface(other.mInterface)
    {
    ...
    VehicleInfo& operator=(VehicleInfo&& other) noexcept
    {
...
private:
    ...
    const std::string kCallSign = {"VehicleInfo"};
};
} /// namespace events
...
class Zone_VehicleInfo_InputProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Zone_VehicleInfo_InputProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Zone_VehicleInfo_InputProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Zone_VehicleInfo_InputProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Zone_VehicleInfo_InputProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Zone_VehicleInfo_InputProxy::HandleType> handleContainer;
    ...
    explicit Zone_VehicleInfo_InputProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , VehicleInfo(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~Zone_VehicleInfo_InputProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Zone_VehicleInfo_InputProxy(Zone_VehicleInfo_InputProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Zone_VehicleInfo_InputProxy& operator=(const Zone_VehicleInfo_InputProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    Zone_VehicleInfo_InputProxy(Zone_VehicleInfo_InputProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , VehicleInfo(std::move(other.VehicleInfo))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Zone_VehicleInfo_InputProxy& operator=(Zone_VehicleInfo_InputProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    /// @brief - event, VehicleInfo
    events::VehicleInfo VehicleInfo;
};
} /// namespace proxy
} /// namespace service
} /// namespace input
} /// namespace zone
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ZONE_VEHICLEINFO_INPUT_PROXY_H