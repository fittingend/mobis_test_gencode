...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ADASINFOHEALTH_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ADASINFOHEALTH_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// INCLUSION HEADER FILES
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// @uptrace{SWS_CM_01004}
#include "adasinfohealth_common.h"
...
public:
    ...
    using FieldType = adas::info::health::type::HealthStatus;
    /// @brief Constructor
    explicit status(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    ...
    status(status&& other) noexcept : mInterface(other.mInterface)
    {
...
private:
    ...
    const std::string kGetterCallSign = {"statusGetter"};
    const std::string kNotifierCallSign = {"statusNotifier"};
};
} /// namespace fields
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<AdasInfoHealthProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<AdasInfoHealthProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<AdasInfoHealthProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<AdasInfoHealthProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<AdasInfoHealthProxy::HandleType> handleContainer;
    ...
    explicit AdasInfoHealthProxy(HandleType& handle)
        : mHandle(handle)
        , mInterface(std::make_unique<para::com::ProxyInterface>(handle.GetInstanceSpecifier(), handle.GetServiceHandle()))
        , status(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~AdasInfoHealthProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    AdasInfoHealthProxy(AdasInfoHealthProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    AdasInfoHealthProxy& operator=(const AdasInfoHealthProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    AdasInfoHealthProxy(AdasInfoHealthProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    AdasInfoHealthProxy& operator=(AdasInfoHealthProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ADASINFOHEALTH_PROXY_H