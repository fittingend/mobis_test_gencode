...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ADASINFOHEALTH_SKELETON_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ADASINFOHEALTH_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit status(para::com::SkeletonInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public:
    ...
    AdasInfoHealthSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~AdasInfoHealthSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    AdasInfoHealthSkeleton(const AdasInfoHealthSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    AdasInfoHealthSkeleton& operator=(const AdasInfoHealthSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    AdasInfoHealthSkeleton(AdasInfoHealthSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    AdasInfoHealthSkeleton& operator=(AdasInfoHealthSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        status = std::move(other.status);
        mInterface->SetE2EErrorHandler([this](const ara::com::e2e::E2EErrorDomain& errorCode, ara::com::e2e::DataID dataID, ara::com::e2e::MessageCounter messageCounter) {
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ADASINFOHEALTH_SKELETON_H