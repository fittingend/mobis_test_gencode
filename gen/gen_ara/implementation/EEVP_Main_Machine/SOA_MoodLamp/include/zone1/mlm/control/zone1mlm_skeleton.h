...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ZONE1MLM_SKELETON_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ZONE1MLM_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit zone1MlmStatus(para::com::SkeletonInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public:
    ...
    Zone1MlmSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
        : mInterface(std::make_unique<para::com::SkeletonInterface>(instanceSpec, mode))
        , zone1MlmStatus(mInterface.get())
    {
        mInterface->SetMethodCallHandler(ksetMlmBrightnessCallSign, [this](const std::vector<std::uint8_t>& data, const para::com::MethodToken /*token*/) {
            HandlesetMlmBrightness(data);
        });
        mInterface->SetMethodCallHandler(ksetMlmColorCallSign, [this](const std::vector<std::uint8_t>& data, const para::com::MethodToken /*token*/) {
            HandlesetMlmColor(data);
        });
    ...
    /// @brief Destructor
    virtual ~Zone1MlmSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    Zone1MlmSkeleton(const Zone1MlmSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    Zone1MlmSkeleton& operator=(const Zone1MlmSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    Zone1MlmSkeleton(Zone1MlmSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    Zone1MlmSkeleton& operator=(Zone1MlmSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        zone1MlmStatus = std::move(other.zone1MlmStatus);
        mInterface->SetMethodCallHandler(ksetMlmBrightnessCallSign, [this](const std::vector<std::uint8_t>& data, const para::com::MethodToken /*token*/) {
...
public:
    ...
    virtual void setMlmBrightness(const std::uint8_t& brightness) = 0;
    /// @brief Method, setMlmColor
    /// @uptrace{SWS_CM_90434}
    virtual void setMlmColor(const std::uint8_t& colorIndex) = 0;
    
private:
    void HandlesetMlmBrightness(const std::vector<std::uint8_t>& data)
    {
        std::uint8_t retResult{1};
        std::vector<std::uint8_t> retData{};
        para::serializer::Deserializer deserializer{data};
        std::uint8_t _brightness_;
        deserializer.read(_brightness_);
        setMlmBrightness(_brightness_);
    }
    void HandlesetMlmColor(const std::vector<std::uint8_t>& data)
    {
        std::uint8_t retResult{1};
        std::vector<std::uint8_t> retData{};
        para::serializer::Deserializer deserializer{data};
        ...
        setMlmColor(_colorIndex_);
    }
    const std::string ksetMlmBrightnessCallSign{"setMlmBrightness"};
    const std::string ksetMlmColorCallSign{"setMlmColor"};
};
} /// namespace skeleton
} /// namespace control
} /// namespace mlm
} /// namespace zone1
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ZONE1MLM_SKELETON_H