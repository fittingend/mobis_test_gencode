...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_MAIN_OTA_TEST_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_MAIN_OTA_TEST_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit Event0(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public:
    ...
    /// @brief Constructor
    explicit Field0(para::com::ProxyInterface* interface) : mInterface(interface)
    {
...
public:
    ...
    /// @brief Constructor
    explicit Method0(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    ...
    /// @brief
    Method0(const Method0& other) = delete;
    Method0& operator=(const Method0& other) = delete;
    /// @brief Move constructor
    Method0(Method0&& other) noexcept : mInterface(other.mInterface)
    {
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
        });
    ...
    /// @brief Move assignment
    Method0& operator=(Method0&& other) noexcept
    {
        mInterface = other.mInterface;
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
    ...
    /// @uptrace{SWS_CM_00196}
    ara::core::Future<Output> operator()(const std::int32_t& Arg0)
    {
        para::serializer::Serializer __serializer__{};
        __serializer__.write(Arg0);
...
private:
    static void HandleMethodReturn(std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData)
    {
        auto* promise = static_cast<ara::core::Promise<Method0::Output>*>(userData);
        if (result == 0)
        {
            para::serializer::Deserializer deserializer{data};
            Method0::Output output;
            deserializer.read(output.Arg1);
        ...
        delete static_cast<ara::core::Promise<Method0::Output>*>(userData);
    }
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"Method0"};
};
} /// namespace methods
/// @uptrace{SWS_CM_00004}
class Main_OTA_TestProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Main_OTA_TestProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Main_OTA_TestProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Main_OTA_TestProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Main_OTA_TestProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Main_OTA_TestProxy::HandleType> handleContainer;
    ...
    explicit Main_OTA_TestProxy(HandleType& handle)
        : mHandle(handle)
        ...
        , Method0(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~Main_OTA_TestProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Main_OTA_TestProxy(Main_OTA_TestProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Main_OTA_TestProxy& operator=(const Main_OTA_TestProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    Main_OTA_TestProxy(Main_OTA_TestProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , Event0(std::move(other.Event0))
        , Field0(std::move(other.Field0))
        , Method0(std::move(other.Method0))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Main_OTA_TestProxy& operator=(Main_OTA_TestProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    ...
    methods::Method0 Method0;
};
} /// namespace proxy
} /// namespace service
} /// namespace otatest
} /// namespace eevp
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_MAIN_OTA_TEST_PROXY_H