...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : zone2roa_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ZONE2ROA_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ZONE2ROA_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit zone2RoaSnsrStatus(para::com::ProxyInterface* interface) : mInterface(interface)
    {
...
public:
    /// @brief Constructor
    explicit controlRoa(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
    virtual ~controlRoa() = default;
    /// @brief
    controlRoa(const controlRoa& other) = delete;
    controlRoa& operator=(const controlRoa& other) = delete;
    /// @brief Move constructor
    controlRoa(controlRoa&& other) noexcept : mInterface(other.mInterface)
    {
    }
    /// @brief Move assignment
    controlRoa& operator=(controlRoa&& other) noexcept
    {
        mInterface = other.mInterface;
        return *this;
    }
    ...
    void operator()(const std::uint8_t& snsrRunReq)
    {
        para::serializer::Serializer __serializer__{};
        __serializer__.write(snsrRunReq);
...
private:
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"controlRoa"};
};
} /// namespace methods
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Zone2RoaProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Zone2RoaProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Zone2RoaProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Zone2RoaProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Zone2RoaProxy::HandleType> handleContainer;
    ...
    explicit Zone2RoaProxy(HandleType& handle)
        : mHandle(handle)
        ...
        , controlRoa(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~Zone2RoaProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Zone2RoaProxy(Zone2RoaProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Zone2RoaProxy& operator=(const Zone2RoaProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    Zone2RoaProxy(Zone2RoaProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , zone2RoaSnsrStatus(std::move(other.zone2RoaSnsrStatus))
        , controlRoa(std::move(other.controlRoa))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Zone2RoaProxy& operator=(Zone2RoaProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    ...
    methods::controlRoa controlRoa;
};
} /// namespace proxy
} /// namespace control
} /// namespace roa
} /// namespace zone2
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ZONE2ROA_PROXY_H