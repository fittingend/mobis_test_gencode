...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ZONE_VEHICLEINFO_INPUT_SKELETON_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ZONE_VEHICLEINFO_INPUT_SKELETON_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace skeleton
{
class Zone_VehicleInfo_InputSkeleton;
...
public:
    ...
    /// @brief Constructor
    explicit VehicleInfo(para::com::SkeletonInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public:
    ...
    Zone_VehicleInfo_InputSkeleton(ara::core::InstanceSpecifier instanceSpec, ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
    ...
    /// @brief Destructor
    virtual ~Zone_VehicleInfo_InputSkeleton() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00134}
    Zone_VehicleInfo_InputSkeleton(const Zone_VehicleInfo_InputSkeleton& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00134}
    Zone_VehicleInfo_InputSkeleton& operator=(const Zone_VehicleInfo_InputSkeleton& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00135}
    Zone_VehicleInfo_InputSkeleton(Zone_VehicleInfo_InputSkeleton&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00135}
    Zone_VehicleInfo_InputSkeleton& operator=(Zone_VehicleInfo_InputSkeleton&& other) noexcept
    {
        mInterface = std::move(other.mInterface);
        VehicleInfo = std::move(other.VehicleInfo);
        mInterface->SetE2EErrorHandler([this](const ara::com::e2e::E2EErrorDomain& errorCode, ara::com::e2e::DataID dataID, ara::com::e2e::MessageCounter messageCounter) {
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ZONE_VEHICLEINFO_INPUT_SKELETON_H