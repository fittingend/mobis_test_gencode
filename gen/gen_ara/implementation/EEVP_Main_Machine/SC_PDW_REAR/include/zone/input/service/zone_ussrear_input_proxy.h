...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : zone_ussrear_input_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_ZONE_USSREAR_INPUT_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_ZONE_USSREAR_INPUT_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit UssRear(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Zone_UssRear_InputProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Zone_UssRear_InputProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Zone_UssRear_InputProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Zone_UssRear_InputProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Zone_UssRear_InputProxy::HandleType> handleContainer;
    ...
    explicit Zone_UssRear_InputProxy(HandleType& handle)
        : mHandle(handle)
    ...
    ~Zone_UssRear_InputProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Zone_UssRear_InputProxy(Zone_UssRear_InputProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Zone_UssRear_InputProxy& operator=(const Zone_UssRear_InputProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    Zone_UssRear_InputProxy(Zone_UssRear_InputProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Zone_UssRear_InputProxy& operator=(Zone_UssRear_InputProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_ZONE_USSREAR_INPUT_PROXY_H