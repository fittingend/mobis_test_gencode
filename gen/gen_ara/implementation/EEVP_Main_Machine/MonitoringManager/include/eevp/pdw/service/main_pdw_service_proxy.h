...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_MAIN_PDW_SERVICE_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_MAIN_PDW_SERVICE_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit UssStatus(para::com::ProxyInterface* interface) : mInterface(interface)
    {
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<Main_PDW_ServiceProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<Main_PDW_ServiceProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<Main_PDW_ServiceProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<Main_PDW_ServiceProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<Main_PDW_ServiceProxy::HandleType> handleContainer;
    ...
    explicit Main_PDW_ServiceProxy(HandleType& handle)
        : mHandle(handle)
    ...
    ~Main_PDW_ServiceProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    Main_PDW_ServiceProxy(Main_PDW_ServiceProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    Main_PDW_ServiceProxy& operator=(const Main_PDW_ServiceProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    Main_PDW_ServiceProxy(Main_PDW_ServiceProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    Main_PDW_ServiceProxy& operator=(Main_PDW_ServiceProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_MAIN_PDW_SERVICE_PROXY_H