...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : soadriverseat_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_SOADRIVERSEAT_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_SOADRIVERSEAT_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    void operator()(const eevp::control::SoaSeatHeightDirection& dir)
    {
...
public:
    ...
    /// @brief Function call operator
    /// @uptrace{SWS_CM_90435}
    void operator()(const eevp::control::SoaSeatReclineDirection& dir)
    {
        para::serializer::Serializer __serializer__{};
        __serializer__.write(dir);
        auto __data__ = __serializer__.ensure();
...
public:
    ...
    /// @brief Function call operator
    /// @uptrace{SWS_CM_90435}
    void operator()(const eevp::control::SoaSeatSlideDirection& dir)
    {
        para::serializer::Serializer __serializer__{};
        __serializer__.write(dir);
        auto __data__ = __serializer__.ensure();
...
public:
    ...
    /// @brief Function call operator
    /// @uptrace{SWS_CM_90435}
    void operator()(const eevp::control::SoaSeatTiltDirection& dir)
    {
        para::serializer::Serializer __serializer__{};
        __serializer__.write(dir);
        auto __data__ = __serializer__.ensure();
...
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<SoaDriverSeatProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<SoaDriverSeatProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<SoaDriverSeatProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<SoaDriverSeatProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<SoaDriverSeatProxy::HandleType> handleContainer;
    ...
    explicit SoaDriverSeatProxy(HandleType& handle)
        : mHandle(handle)
    ...
    ~SoaDriverSeatProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    SoaDriverSeatProxy(SoaDriverSeatProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    SoaDriverSeatProxy& operator=(const SoaDriverSeatProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    SoaDriverSeatProxy(SoaDriverSeatProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    SoaDriverSeatProxy& operator=(SoaDriverSeatProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_SOADRIVERSEAT_PROXY_H