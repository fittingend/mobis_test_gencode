...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
/// GENERATED FILE NAME               : dummytest_proxy.h
...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_DUMMYTEST_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_DUMMYTEST_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    /// @brief Constructor
    explicit DeviceEvent(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public:
    ...
    /// @brief Constructor
    explicit DeviceField(para::com::ProxyInterface* interface) : mInterface(interface)
    {
...
public:
    ...
    /// @brief Constructor
    explicit DeviceMethod(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    ...
    /// @brief Destructor
    virtual ~DeviceMethod() = default;
    /// @brief
    DeviceMethod(const DeviceMethod& other) = delete;
    DeviceMethod& operator=(const DeviceMethod& other) = delete;
    /// @brief Move constructor
    DeviceMethod(DeviceMethod&& other) noexcept : mInterface(other.mInterface)
    {
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
        });
    ...
    /// @brief Move assignment
    DeviceMethod& operator=(DeviceMethod&& other) noexcept
    {
        mInterface = other.mInterface;
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
    ...
    /// @uptrace{SWS_CM_00196}
    ara::core::Future<Output> operator()(const std::int16_t& DeviceNumber)
    {
        para::serializer::Serializer __serializer__{};
        __serializer__.write(DeviceNumber);
...
private:
    static void HandleMethodReturn(std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData)
    {
        auto* promise = static_cast<ara::core::Promise<DeviceMethod::Output>*>(userData);
        if (result == 0)
        {
            para::serializer::Deserializer deserializer{data};
            DeviceMethod::Output output;
            deserializer.read(output.DeviceState);
        ...
        delete static_cast<ara::core::Promise<DeviceMethod::Output>*>(userData);
    }
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"DeviceMethod"};
};
} /// namespace methods
/// @uptrace{SWS_CM_00004}
class DummyTestProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<DummyTestProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<DummyTestProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<DummyTestProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<DummyTestProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<DummyTestProxy::HandleType> handleContainer;
    ...
    explicit DummyTestProxy(HandleType& handle)
        : mHandle(handle)
        ...
        , DeviceMethod(mInterface.get())
    {
    }
    /// @brief Destructor
    /// @uptrace{SWS_CM_10446}
    ~DummyTestProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    DummyTestProxy(DummyTestProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    DummyTestProxy& operator=(const DummyTestProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    DummyTestProxy(DummyTestProxy&& other) noexcept
        : mHandle(std::move(other.mHandle))
        , mInterface(std::move(other.mInterface))
        , DeviceEvent(std::move(other.DeviceEvent))
        , DeviceField(std::move(other.DeviceField))
        , DeviceMethod(std::move(other.DeviceMethod))
    {
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    DummyTestProxy& operator=(DummyTestProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
public:
    ...
    methods::DeviceMethod DeviceMethod;
};
} /// namespace proxy
} /// namespace dummy
} /// namespace test
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_DUMMYTEST_PROXY_H