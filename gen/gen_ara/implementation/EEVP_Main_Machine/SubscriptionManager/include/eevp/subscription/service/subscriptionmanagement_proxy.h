...
public:
    ...
    /// @brief Constructor
    explicit notifySubscriptionInfo(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    }
    /// @brief Destructor
...
public:
    ...
    /// @brief Constructor
    explicit getSubscriptionInfo(para::com::ProxyInterface* interface) : mInterface(interface)
    {
    ...
    /// @brief Destructor
    virtual ~getSubscriptionInfo() = default;
    /// @brief
    getSubscriptionInfo(const getSubscriptionInfo& other) = delete;
    getSubscriptionInfo& operator=(const getSubscriptionInfo& other) = delete;
    /// @brief Move constructor
    getSubscriptionInfo(getSubscriptionInfo&& other) noexcept : mInterface(other.mInterface)
    {
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
        });
    ...
    /// @brief Move assignment
    getSubscriptionInfo& operator=(getSubscriptionInfo&& other) noexcept
    {
        mInterface = other.mInterface;
        mInterface->SetMethodReturnHandler(kCallSign, [](std::uint8_t result, const std::vector<std::uint8_t>& data, void* userData) {
            HandleMethodReturn(result, data, userData);
...
private:
    ...
    {
        auto* promise = static_cast<ara::core::Promise<getSubscriptionInfo::Output>*>(userData);
        if (result == 0)
        {
            para::serializer::Deserializer deserializer{data};
            getSubscriptionInfo::Output output;
            deserializer.read(output.isSubscription);
        ...
        delete static_cast<ara::core::Promise<getSubscriptionInfo::Output>*>(userData);
    }
    para::com::ProxyInterface* mInterface;
    const std::string kCallSign{"getSubscriptionInfo"};
};
} /// namespace methods
...
public:
    ...
    explicit SubscriptionManagementProxy(HandleType& handle)
        ...
        , getSubscriptionInfo(mInterface.get())
    {
    }
    /// @brief Destructor
    ...
    SubscriptionManagementProxy(SubscriptionManagementProxy&& other) noexcept
        ...
        , getSubscriptionInfo(std::move(other.getSubscriptionInfo))
    {
...
public:
    ...
    methods::getSubscriptionInfo getSubscriptionInfo;
};
} /// namespace proxy
} /// namespace service
} /// namespace subscription
