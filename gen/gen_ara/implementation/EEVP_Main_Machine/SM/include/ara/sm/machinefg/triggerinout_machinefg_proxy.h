...
///                                                                                                        
///////////////////////////////////////////////////////////////////////////////////////////////////////////
#ifndef PARA_COM_GEN_SERVICE_INTERFACE_TRIGGERINOUT_MACHINEFG_PROXY_H
#define PARA_COM_GEN_SERVICE_INTERFACE_TRIGGERINOUT_MACHINEFG_PROXY_H
///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
    ...
    using FieldType = ara::sm::MachineState;
    /// @brief Constructor
...
class TriggerInOut_MachineFGProxy
{
public: 
    ...
    static ara::core::Result<ara::com::FindServiceHandle> StartFindService(ara::com::FindServiceHandler<TriggerInOut_MachineFGProxy::HandleType> handler, ara::core::InstanceSpecifier instanceSpec)
    {
        ...
        auto findCallback = [&, handler, findHandle, instanceSpec](std::vector<para::com::ServiceHandle> services) {
            ara::com::ServiceHandleContainer<TriggerInOut_MachineFGProxy::HandleType> handleContainer;
    ...
    static ara::core::Result<ara::com::ServiceHandleContainer<TriggerInOut_MachineFGProxy::HandleType>> FindService(ara::core::InstanceSpecifier instanceSpec)
    {
        auto result = para::com::ProxyInterface::FindService(instanceSpec);
        if (!result.HasValue())
        {
            return ara::core::Result<ara::com::ServiceHandleContainer<TriggerInOut_MachineFGProxy::HandleType>>::FromError(result.Error());
        }
        ara::com::ServiceHandleContainer<TriggerInOut_MachineFGProxy::HandleType> handleContainer;
    ...
    explicit TriggerInOut_MachineFGProxy(HandleType& handle)
        : mHandle(handle)
    ...
    ~TriggerInOut_MachineFGProxy() = default;
    /// @brief Delete copy constructor
    /// @uptrace{SWS_CM_00136}
    TriggerInOut_MachineFGProxy(TriggerInOut_MachineFGProxy& other) = delete;
    /// @brief Delete copy assignment
    /// @uptrace{SWS_CM_00136}
    TriggerInOut_MachineFGProxy& operator=(const TriggerInOut_MachineFGProxy& other) = delete;
    /// @brief Move constructor
    /// @uptrace{SWS_CM_00137}
    TriggerInOut_MachineFGProxy(TriggerInOut_MachineFGProxy&& other) noexcept
    ...
    /// @brief Move assignment
    /// @uptrace{SWS_CM_00137}
    TriggerInOut_MachineFGProxy& operator=(TriggerInOut_MachineFGProxy&& other) noexcept
    {
        mHandle = std::move(other.mHandle);
        mInterface = std::move(other.mInterface);
        mInterface->StopFindService();
...
#endif /// PARA_COM_GEN_SERVICE_INTERFACE_TRIGGERINOUT_MACHINEFG_PROXY_H